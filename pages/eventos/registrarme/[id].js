	...
	return (
		<>
			<Head>
				<meta
					name="description"
					content={`Llene el formulario para registrarse en el evento ${evento.nombreDelEvento} en ${evento.lugar} y reserve su espacio. Ven a recibir lo que Dios tiene para ti en este dia.  Bendiciones.`}
				/>
			...
			<Layout
				pageTitle={`Registración para el evento ${
					evento.nombreDelEvento
				} | Quedan ${
					evento.cantidadDisponible - evento.registrados.length
				} espacio(s) disponibles.`}>
