          ...
          <div className="col-lg-12">
            <div className="contact-one__content">
              <div className="contact-one__images">
                <img src="/assets/images/resources/contact-1.png"
                  className="wow fadeInUp" data-wow-duration="1500ms" alt="iconos de contacto" />
              </div>
              <div className="contact-one__infos">
                <div className="contact-one__infos-single">
                  ...
                  <div className="contact-one__infos-content">
                    <h3>Dirección</h3>
                    <p>649 Old Mill Rd, <br />Millersville, MD 21108<br /></p>
                  </div>
                </div>
                <div className="contact-one__infos-single">
                  <div className="contact-one__infos-icon">
                  ...
                  <div className="contact-one__infos-content">
                    <h3>Correo</h3>
                    <p><a href="mailto:informacion@miciudadderefugio.com">informacion@miciudadderefugio.com</a>
                    </p>
                  </div>
                </div>
                {/* <div className="contact-one__infos-single">
              ...
              <form action="" className="contact-form-validated contact-one__form">
                <div className="row">
                  ...
                  <div className="col-md-12">
                    ...
                    <button type="submit"
                      className="thm-btn contact-one__form-btn">Enviar
                                        </button>
                  </div>
                </div>
              </form>
