	...
	return (
		<>
			<Head>
				<meta
					name="description"
					content="Verifique las personas que se han registrado para los eventos programados de la Iglesia Ciudad de Refugio."
				/>
					...
					<section className="">
                        ...
                        mb-0">
											...
											<div className="mt-3 mb-0">
												...
												<Link href={`/eventos/registrados/${e._id}`}>
													<a className="thm-btn cta-three__btn mt-3">
