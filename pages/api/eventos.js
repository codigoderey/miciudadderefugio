...
const handlePostRequest = async (req, res) => {
  ...
  try {
    ...
    const { nombreDelEvento, organizadoPor, lugar, descripcionDelEvento, direccionCalle, direccionCiudad, direccionEstado, direccionZipCode, cantidadDisponible, imageUrl, fechasYHorasDelEvento } = req.body
